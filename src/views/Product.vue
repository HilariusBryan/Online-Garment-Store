...
import HeaderGarment from '@/components/HeaderGarment.vue';
import FooterGarment from '@/components/FooterGarment.vue';
import RelatedGarment from '@/components/RelatedGarment.vue';
...
export default {
  ...
  methods: {
    changeImage(urlImage){
     ...
     setDataPicture(data){
      //replace productdetails dengan data dari API
      this.productDetails = data;
      //replace value gamabr dengan data dari API

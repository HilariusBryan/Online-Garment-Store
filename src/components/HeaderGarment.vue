            ...
            <div class="container">
                <div class="ht-left">
                    <div class="mail-service">
                        <i class=" fa fa-envelope"></i> yellowclaw@gmail.com
                    </div>
                    <div class="phone-service">
                        <i class=" fa fa-phone"></i> +81216223790
                    </div>
                </div>
            </div>
        </div>
...
export default {
  ...
  methods: {
    removeItem(idx){
        //cari tahu id dari isi item yang akan dihapus
        ...
        //cookan idx item dengan id yang ada di storage
